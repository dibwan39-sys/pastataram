            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex items-center gap-3 mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  /* Icon-only, so the name has to be supplied: there is no text
                     for a screen reader to read, and the SVG is decoration. */
                  aria-label={isAr ? 'باستاتا رام على إنستغرام' : 'PASTATARAM on Instagram'}
