      ...
      {open && (
        <>
          <motion.div
            ...
            style={{ background: 'rgba(30, 7, 19,0.78)', backdropFilter: 'blur(6px)' }}
            aria-hidden
          />
          ...
          <div className="fixed inset-0 z-[95] flex items-end justify-center sm:items-center sm:p-6">
            ...
            >
              ...
              <button
                ...
                style={{ background: 'rgba(30, 7, 19,0.55)', backdropFilter: 'blur(8px)' }}
              >
              ...
              <div className="relative aspect-[4/3] w-full overflow-hidden sm:rounded-t-[2rem]">
                ...
                <div
                  ...
                  style={{ background: 'linear-gradient(to top, rgba(51, 12, 30,0.92) 0%, transparent 55%)' }}
                />
                  ...
                  <div className="mb-2 flex flex-wrap gap-2">
                    ...
                    {fallback.featured && !fallback.bestseller && (
                      <span
                        ...
                        style={{ background: 'rgba(30, 7, 19,0.7)', color: '#F6E0C4' }}
                      >
