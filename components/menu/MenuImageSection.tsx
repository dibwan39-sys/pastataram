    ...
    >
      <div className={`${compact ? 'max-w-3xl' : 'max-w-4xl'} mx-auto px-4 sm:px-6`}>
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(145deg, rgba(82, 22, 47,0.96) 0%, rgba(82, 22, 47,0.35) 100%)',
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                style={{ background: 'rgba(30, 7, 19,0.92)', backdropFilter: 'blur(8px)' }}
                onClick={close}
              >
                {/* Toolbar */}
                <div
                  className="absolute top-4 left-1/2 -translate-x-1/2 z-10 flex items-center gap-2 px-3 py-2 rounded-full"
                  style={{ background: 'rgba(51, 12, 30,0.95)', border: '1px solid rgba(231,198,164,0.4)', boxShadow: '0 6px 24px rgba(0,0,0,0.3)' }}
                ...
                <button
                  ...
                  style={{ background: 'rgba(51, 12, 30,0.95)', border: '1px solid rgba(231,198,164,0.4)', color: '#D8C2BD', boxShadow: '0 6px 24px rgba(0,0,0,0.3)' }}
                >
                  <X className="w-6 h-6" />
                </button>
                ...
                <p className="absolute bottom-5 left-1/2 -translate-x-1/2 text-xs font-medium pointer-events-none" style={{ color: 'rgba(51, 12, 30,0.7)' }}>
