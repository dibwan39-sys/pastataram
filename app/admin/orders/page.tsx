...
const mockOrders = [
  { id: 'o1', orderNumber: 'PT-001240', customerName: 'محمد العمري', customerPhone: '0501234567', status: 'pending' as OrderStatus, total: 54, items: [{ menuItem: { name: 'Pastata Ram', nameAr: 'باستاتا رام', image: '/images/f1.webp' }, quantity: 2, extras: [], totalPrice: 54 }], createdAt: new Date(), updatedAt: new Date() },
  { id: 'o2', orderNumber: 'PT-001239', customerName: 'Sarah Al-Rashid', customerPhone: '0507654321', status: 'preparing' as OrderStatus, total: 41, items: [{ menuItem: { name: 'Ramcine', nameAr: 'رامسين', image: '/images/f2.webp' }, quantity: 1, extras: [], totalPrice: 27 }, { menuItem: { name: 'Pastata Balls', nameAr: 'باستاتا بولز', image: '/images/f3.webp' }, quantity: 1, extras: [], totalPrice: 14 }], createdAt: new Date(Date.now() - 600000), updatedAt: new Date() },
  { id: 'o3', orderNumber: 'PT-001238', customerName: 'فيصل القحطاني', customerPhone: '0509876543', status: 'ready' as OrderStatus, total: 27, items: [{ menuItem: { name: 'Pastata Ram', nameAr: 'باستاتا رام', image: '/images/f1.webp' }, quantity: 1, extras: [], totalPrice: 27 }], createdAt: new Date(Date.now() - 1200000), updatedAt: new Date() },
