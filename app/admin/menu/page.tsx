    ...
    <div className="space-y-6">
      ...
      <div className="relative max-w-sm">
        ...
        <input
          ...
          className="w-full ps-10 pe-4 py-2.5 rounded-xl border border-brand-rose/30 bg-[var(--brand-noir-2)] dark:bg-brand-surface/30 text-brand-espresso dark:text-brand-ivory placeholder-brand-latte focus:outline-none focus:border-brand-rose-gold text-sm"
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filtered.map((item) => (
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className={`bg-[var(--brand-noir-2)] dark:bg-[var(--brand-noir-2)] rounded-2xl shadow-card overflow-hidden ${!item.available ? 'opacity-60' : ''}`}
          >
        ...
        {showForm && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-4 md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-lg z-[60] bg-[var(--brand-noir-2)] dark:bg-[var(--brand-noir-2)] rounded-3xl shadow-brand-lg overflow-y-auto max-h-[90vh]"
            >
              <div className="p-6">
