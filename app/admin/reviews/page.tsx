    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {filtered.map((review) => (
          <div
            key={review.id}
            className={`bg-[#181015] dark:bg-[#181015] rounded-2xl p-5 shadow-card ${!review.approved ? 'border-l-4 border-amber-400' : review.featured ? 'border-l-4 border-brand-rose-gold' : ''}`}
          >
