    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {filtered.map((review) => (
          <div
            key={review.id}
            className={`bg-[var(--brand-noir-2)] dark:bg-[var(--brand-noir-2)] rounded-2xl p-5 shadow-card ${!review.approved ? 'border-l-4 border-amber-400' : review.featured ? 'border-l-4 border-brand-rose-gold' : ''}`}
          >
