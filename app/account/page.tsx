...
export default function AccountPage() {
  ...
  if (!isLoggedIn) {
    return (
      <PageWrapper>
        <section className="min-h-[80vh] flex items-center justify-center py-20 bg-gradient-to-br from-brand-cream via-brand-blush/20 to-brand-pearl dark:from-[var(--brand-noir)] dark:to-[var(--brand-noir-2)]">
